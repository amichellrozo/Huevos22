 ...
 * @author michi
 */
public class Controlador_informe_ventas  implements ActionListener {
    
      Vista_informe_ventas vis1;
    BD_huevos mom;
    Controlador_informe_ventas(Vista_informe_ventas v1, BD_huevos m) {
        mom = m;
        vis1 = v1;
        ...
        vis1.Opciones.setModel(mom.combo_fecha());
        vis1.Opciones1.setModel(mom.combo_fecha());
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vis1.Mostrar) {
            ...
            model = mom.Lista_IVENTAS(vis1.Opciones.getSelectedItem().toString(), vis1.Opciones1.getSelectedItem().toString());
